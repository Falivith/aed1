...
int main(){
    ...
    void* pBuffer = malloc(5*sizeof(int));            //armazena espaço para as variáveis do programa
    ...
    *(int*)ptr = 0;                                   //5º Campo INT de pBuffer = I usado para contadores FOR, utilitário e afins
...
void* add_cadastro(void *pBuffer){
    ...
    void* rem_cadastro(void *pBuffer){
        ...
        void* rem_user = pBuffer + 4*sizeof(int);           //Campo 5: Utilitário para while/for
        *(int*)rem_user = 1; 
        void* n_users = pBuffer + 2*sizeof(int);            //Campo 3: numero de usuarios

        while(*(int*)rem_user>0 && *(int*)rem_user<QNT_PESSOAS){
